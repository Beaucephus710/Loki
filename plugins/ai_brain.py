        ...
        try:
            ...
            if r.status_code == 200:
                ...
                if now - self._last_error_log > 30:
                    print(f"[Bettercap] API returned 405 Method Not Allowed for {url}. Check API docs or use OPTIONS to see allowed methods.")
                    self._last_error_log = now
                # increase backoff so we don't spam while you investigate
